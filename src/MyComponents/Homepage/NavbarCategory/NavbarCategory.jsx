...
const NavbarCategory = () => {
  ...
  const AllcategoryData=useSelector((storeData)=>{
    return storeData.Allcategory
  })
  console.log(AllcategoryData)
useEffect(()=>{
     axios.get('https://lokender-backend-api.vercel.app/api/v1/admin/getCategorieswithsubcat').then((res)=>{
      ...
      <div className="hometop2">
        <div className="hometop2cont">
          ...
          </div> */}
          {
            ...
            <img src={e.categories.image} alt="" />
            <p>{e.categories.name}</p>
          </div>
              )
            })
          }
