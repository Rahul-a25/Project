...
const Cart = () => {
  ...
  const CartApi=useSelector((storeData)=>{
    return storeData.Cart
  })
  const remove=(e)=>{
 
    dispatch(DeleteAction(e))
    alert('Data removed from Cart')
  }
  return (
    <>
      <Navbar />
          ...
          return (
            <div className="cart-main">
             ...
             <div className="content">
                   <h2 style={{fontSize:"30px"}}>Brand Name:  <span style={{marginLeft:"10px",fontWeight:"bold"}}>{e.brand}</span> </h2>
                   <p>Price: <span style={{marginLeft:'10px',fontWeight:"bold"}}>{e.price}</span> </p>
                   <p>Review:<span style={{marginLeft:'10px',fontWeight:"bold"}}>{e.numOfReviews}</span></p>
                   <p>SimType:<span style={{marginLeft:'10px',fontWeight:"bold"}}>{e.simType}</span></p>
                   <h3>Stock:<span style={{marginLeft:'10px',fontWeight:"bold"}}>{e.stock}</span></h3>
                   <button className="btn-wala" onClick={()=>remove(e)}>Remove Data</button>
             </div>
